        ...
        <div class="login-box">
            ...
            <div class="google-button-wrapper">
              <button class="google-login" @click="signInWithGoogle">
                <img src="@/assets/images/google-icon.webp" class="gmail-icon" />
...
import  signIn  from "@/firebase/session"
    ...
    methods: {
        ...
        async loginUser() {
          ...
          if (res === true) {
            ...
            console.log('Sign-in failed with error code:', result);
          }
        ...
        //   logInWithGoogle();
            if (this.isSigningIn) return; // Prevent multiple sign-in attempts
            this.isSigningIn = true; // Set signing-in state
            ...
            try {
                ...
                this.isSigningIn = false; // Reset signing-in state
            }
        },
    },
};
